...
// All Season II participants (npubs)
...
// Competition IDs (from database)
const COMPETITIONS = [
  { external_id: 'season2-running', id: '3a6a251b-50a9-434e-8ba2-85b40ac0bfdc' },
  { external_id: 'season2-walking', id: '0e9fee0e-0135-438b-91ac-73509f9152d7' },
  { external_id: 'season2-cycling', id: 'f16c83e3-d3ea-48d3-bee8-6833491bd34f' },
];
